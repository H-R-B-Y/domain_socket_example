...
/*   Updated: 2025/10/05 14:44:50 by hbreeze          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
int	_on_join_handler(struct s_server *srv);
...
*/
int	_handle_msg(struct s_server *srv, int fd);
...
*/
int	_handle_disconnect(struct s_server *srv, int fd);
